...
//        gctx.fillText(data[i].sortName, x, y + 5); // Write base text for classes 
        ...
        //random color
        var columncolor=getRandomColour();
        if (colorarray==null) {
            colorarray.push(columncolor);
             gctx.fillStyle = columncolor;
        }else {
            for (var i = 0; i < colorarray.length; i++) {
                while(colorarray[i]==columncolor){
                    columncolor=getRandomColour();
                }
            }
            colorarray.push(columncolor);
            gctx.fillStyle = columncolor;
...
//        gctx.fillStyle = getRandomColour(); // fill Colur of bar  
        colorarray.push()
    ...
    //draw trục tung,lấy độ dài theo cột dài nhất
    gctx.moveTo(10, y+5);
    gctx.lineTo(10, ytop-40);  
    gctx.stroke();
    gctx.moveTo(10, y+5);
    gctx.lineTo(xmax-20, y+5); 
    gctx.stroke();
